...
export const metadata: Metadata = {
  title: "Learn Torah like a game",
  description: "Build a streak, earn points, and master texts with spaced repetition flashcards. Make daily learning a habit that sticks.",
};
...
const features = [
  {
    icon: "🔥",
    title: "Daily Streaks",
    description: "Build momentum with daily study goals. Watch your streak grow!",
  },
  {
    icon: "⭐",
    title: "Earn Points",
    description: "Get rewarded for every card you review. Level up as you learn.",
  },
  {
    icon: "🧠",
    title: "Spaced Repetition",
    description: "Smart scheduling ensures you review at the optimal time.",
  },
];
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-20">
        ...
        <div className="mt-16 grid gap-6 sm:grid-cols-3 max-w-4xl w-full stagger-children">
          {features.map((feature) => (
            <div
              key={feature.title}
              className="rounded-3xl bg-[var(--surface-elevated)] border border-white/5 p-6 hover:translate-y-[-4px] transition-all duration-300"
            >
